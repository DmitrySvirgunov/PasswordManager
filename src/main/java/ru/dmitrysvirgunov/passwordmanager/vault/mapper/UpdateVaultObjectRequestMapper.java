...
import ru.dmitrysvirgunov.passwordmanager.vault.dto.request.UpdateVaultObjectRequest;
...
public interface UpdateVaultObjectRequestMapper {
    ...
    UpdateVaultObjectInput toInput(UpdateVaultObjectRequest request);
