...
import ru.dmitrysvirgunov.passwordmanager.vault.dto.request.DeleteVaultObjectRequest;
...
public interface DeleteVaultObjectRequestMapper {
    ...
    DeleteVaultObjectInput toInput(DeleteVaultObjectRequest request);
