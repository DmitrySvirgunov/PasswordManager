...
public interface CompleteVaultBlobUploadRequestMapper {

    @Mapping(target = "ciphertextSha256", source = "ciphertextSha256Base64", qualifiedByName = "decodeBase64")
    CompleteVaultBlobUploadInput toInput(CompleteVaultBlobUploadRequest request);
